...
final class BitArrayBuilder {
  ...
  static BitArray buildBitArray(List<com.sobot.chat.widget.zxing.oned.rss.expanded.ExpandedPair> pairs) {
    ...
    com.sobot.chat.widget.zxing.oned.rss.expanded.ExpandedPair firstPair = pairs.get(0);
    ...
    for (int i = 1; i < pairs.size(); ++i) {
      com.sobot.chat.widget.zxing.oned.rss.expanded.ExpandedPair currentPair = pairs.get(i);
