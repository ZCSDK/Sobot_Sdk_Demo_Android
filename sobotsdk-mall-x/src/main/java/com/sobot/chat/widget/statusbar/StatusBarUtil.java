...
public class StatusBarUtil {
    ...
    public static int SOBOT_STATUS_HIGHT = 0;//状态栏高度
        ...
        try {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
                ...
                if (fakeStatusBarView != null) {
                    ...
                    decorView.addView(createStatusBarView(activity, drawable));
                }
    ...
    private static int getStatusBarHeight(Activity context) {
        ...
        int result = 0;
        result = SharedPreferencesUtil.getIntData(context,"SobotStatusBarHeight", 0);
        if (result == 0) {
