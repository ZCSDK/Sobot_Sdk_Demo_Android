...
public final class BitMatrix implements Cloneable {
  ...
  public void xor(BitMatrix mask) {
    ...
    com.sobot.chat.widget.zxing.common.BitArray rowArray = new com.sobot.chat.widget.zxing.common.BitArray(width);
   ...
   *         your own row
   */
  public com.sobot.chat.widget.zxing.common.BitArray getRow(int y, com.sobot.chat.widget.zxing.common.BitArray row) {
    if (row == null || row.getSize() < width) {
      row = new com.sobot.chat.widget.zxing.common.BitArray(width);
    } else {
      row.clear();
    }
    int offset = y * rowSize;
  ...
  /**
   * @param y row to set
   * @param row {@link com.sobot.chat.widget.zxing.common.BitArray} to copy from
   */
  public void setRow(int y, com.sobot.chat.widget.zxing.common.BitArray row) {
  ...
  public void rotate180() {
    ...
    com.sobot.chat.widget.zxing.common.BitArray topRow = new com.sobot.chat.widget.zxing.common.BitArray(width);
    com.sobot.chat.widget.zxing.common.BitArray bottomRow = new BitArray(width);
