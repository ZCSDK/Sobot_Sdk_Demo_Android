...
public class SobotBackDialog extends Dialog {
    ...
    private void initView() {
        ...
        sobot_btn_cancle_conversation.setText(ResourceUtils.getResString(getContext(),"sobot_cancle_conversation"));
        sobot_btn_temporary_leave = (Button) findViewById(ResourceUtils.getIdByName(getContext(), "id", "sobot_btn_temporary_leave"));
        sobot_btn_temporary_leave.setText(ResourceUtils.getResString(getContext(),"sobot_temporary_leave"));
        coustom_pop_layout = (LinearLayout) findViewById(ResourceUtils.getIdByName(getContext(), "id", "pop_layout"));
        sobot_tv_will_end_conversation = (TextView) findViewById(ResourceUtils.getIdByName(getContext(), "id", "sobot_tv_will_end_conversation"));
        sobot_tv_will_end_conversation.setText(ResourceUtils.getResString(getContext(),"sobot_will_end_conversation"));
