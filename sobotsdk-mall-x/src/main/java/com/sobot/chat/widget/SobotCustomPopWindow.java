...
public class SobotCustomPopWindow implements PopupWindow.OnDismissListener{
     ...
     * @return
     */
    public SobotCustomPopWindow showAsDropDown(View anchor, int xOff, int yOff){
    ...
    public SobotCustomPopWindow showAsDropDown(View anchor){
        if(mPopupWindow!=null){
            try {
     ...
     * @return
     */
    public SobotCustomPopWindow showAtLocation(View parent, int gravity, int x, int y){
        if(mPopupWindow!=null){
            try {
    ...
    public static class PopupWindowBuilder{
        ...
        public PopupWindowBuilder(Context context){
            mCustomPopWindow = new SobotCustomPopWindow(context);
        }
        ...
        public PopupWindowBuilder setWidthMatchParent(boolean widthMatchParent){
            mCustomPopWindow.widthMatchParent = widthMatchParent;
            return this;
        }
