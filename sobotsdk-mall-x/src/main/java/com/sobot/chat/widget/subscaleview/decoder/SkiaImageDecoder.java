...
/**
 * Default implementation of {@link com.sobot.chat.widget.subscaleview.decoder.ImageDecoder}
...
public class SkiaImageDecoder implements ImageDecoder {
    ...
    public SkiaImageDecoder(@Nullable Bitmap.Config bitmapConfig) {
        Bitmap.Config globalBitmapConfig = SobotScaleImageView.getPreferredBitmapConfig();
