...
public class StCameraView extends FrameLayout implements CameraInterface.CameraOpenOverCallback, SurfaceHolder
    ...
    public StCameraView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        //get AttributeSet
//        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.StICameraView, defStyleAttr, 0);
//        iconSize = a.getDimensionPixelSize(R.styleable.StCameraView_iconSize, (int) TypedValue.applyDimension(
//                TypedValue.COMPLEX_UNIT_SP, 35, getResources().getDisplayMetrics()));
//        iconMargin = a.getDimensionPixelSize(R.styleable.StCameraView_iconMargin, (int) TypedValue.applyDimension(
//                TypedValue.COMPLEX_UNIT_SP, 15, getResources().getDisplayMetrics()));
//        iconSrc = a.getResourceId(R.styleable.StCameraView_iconSrc, R.drawable.ic_camera);
//        iconLeft = a.getResourceId(R.styleable.StCameraView_iconLeft, 0);
//        iconRight = a.getResourceId(R.styleable.StCameraView_iconRight, 0);
//        duration = a.getInteger(R.styleable.StCameraView_duration_max, 10 * 1000);       //没设置默认为10s
//        a.recycle();
        initAttrs();
        initData();
        initView();
...
//        });
        ...
        //拍照 录像
        mCaptureLayout.setCaptureLisenter(new StCaptureListener() {
            @Override
...
//                mFlashLamp.setVisibility(VISIBLE);
        ...
        //确认 取消
        mCaptureLayout.setTypeLisenter(new StTypeListener() {
            @Override
            public void cancel() {
                recycleBitmap();
        ...
        mCaptureLayout.setLeftClickListener(new StClickListener() {
            @Override
            public void onClick() {
        ...
        mCaptureLayout.setRightClickListener(new StClickListener() {
            @Override
            public void onClick() {
...
//                    Log.i("CJT", "result = " + (result - firstTouchLength));
    ...
    public void setJCameraLisenter(StCameraListener jCameraLisenter) {
    ...
    //启动Camera错误回调
    public void setErrorLisenter(StErrorListener errorLisenter) {
...
//        }
    ...
    public void playVideo(Bitmap firstFrame, final String url) {
        videoUrl = url;
        StCameraView.this.firstFrame = firstFrame;
    ...
    public void setLeftClickListener(StClickListener clickListener) {
        this.leftClickListener = clickListener;
    }

    public void setRightClickListener(StClickListener clickListener) {
