...
public class SobotTicketEvaluateDialog extends SobotActionSheet {
    ...
    protected void initView() {
        ...
        sobot_add_content.setHint(ResourceUtils.getResString(mContext,"sobot_edittext_hint"));
        sobot_tv_evaluate_title= (TextView) findViewById(getResId("sobot_tv_evaluate_title"));
        sobot_tv_evaluate_title.setText(ResourceUtils.getResString(mContext,"sobot_please_comment"));
        sobot_close_now = (Button) findViewById(getResId("sobot_close_now"));
        sobot_close_now.setText(ResourceUtils.getResString(mContext,"sobot_btn_submit_text"));
