...
public class PagerGridLayoutManager extends RecyclerView.LayoutManager
    ...
    private void recycleAndFillItems(RecyclerView.Recycler recycler, RecyclerView.State state,
        ...
        LogUtils.i("mOffsetX = " + mOffsetX);
        LogUtils.i("mOffsetY = " + mOffsetY);
    ...
    public void onScrollStateChanged(int state) {
        LogUtils.i("onScrollStateChanged = " + state);
        mScrollState = state;
    ...
    private Rect getItemFrameByPosition(int pos) {
        ...
        if (null == rect) {
            ...
            // 状态输出，用于调试
            LogUtils.i("pagePos = " + pagePos);
            LogUtils.i("行 = " + row);
            LogUtils.i("列 = " + col);

            LogUtils.i("offsetX = " + offsetX);
    ...
    private int getPageIndexByOffset() {
        ...
        LogUtils.i("getPageIndexByOffset pageIndex = " + pageIndex);
        return pageIndex;
    }
    ...
    int findNextPageFirstPos() {
        ...
        LogUtils.e("computeScrollVectorForPosition next = " + page);
    ...
    int findPrePageFirstPos() {
        ...
        int page = mLastPageIndex;
        page--;
        LogUtils.e("computeScrollVectorForPosition pre = " + page);
        if (page < 0) {
            page = 0;
        }
        LogUtils.e("computeScrollVectorForPosition pre = " + page);
    ...
    private void setPageIndex(int pageIndex, boolean isScrolling) {
        LogUtils.e("setPageIndex = " + pageIndex + ":" + isScrolling);
    ...
    public void scrollToPage(int pageIndex) {
        ...
        LogUtils.e("mTargetOffsetXBy = " + mTargetOffsetXBy);
        LogUtils.e("mTargetOffsetYBy = " + mTargetOffsetYBy);
