...
public class SobotTransferCustomActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private RelativeLayout sobot_isQueueFirst;//是否排队优先
    private RelativeLayout sobot_tv_left;
    private boolean isUseVoice = false;//是否显示咨询信息，默认不显示
    private boolean isQueueFirst = false;//是否排队优先
    private ImageView imgOpenVoice;
    private ImageView img_isQueueFirst;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        findvViews();
        isUseVoice =SobotSPUtil.getBooleanData(this, "sobot_isArtificialIntelligence", isUseVoice);
        setVoice(isUseVoice);
        isQueueFirst=SobotSPUtil.getBooleanData(this, "sobot_isQueueFirst", isQueueFirst);
        setQueueFirst(isQueueFirst);
    ...
    private void findvViews(){
        ...
        sobot_isQueueFirst = (RelativeLayout) findViewById(R.id.sobot_isQueueFirst);
        imgOpenVoice = (ImageView) findViewById(R.id.img_open_notify);
        img_isQueueFirst = (ImageView) findViewById(R.id.img_isQueueFirst);
        sobot_isArtificialIntelligence.setOnClickListener(this);
        sobot_isQueueFirst.setOnClickListener(this);
    ...
    public void onClick(View v) {
        if (v == sobot_tv_left){
            ...
            setVoice(isUseVoice);
        } else if (v == sobot_isQueueFirst){
            isQueueFirst = !isQueueFirst;
            setQueueFirst(isQueueFirst);
        }
    }
    ...
    private void setQueueFirst(boolean open){
        if(open){
            isQueueFirst = true;
            img_isQueueFirst.setBackgroundResource(R.drawable.sobot_demo_icon_open);
            SobotSPUtil.saveBooleanData(this, "sobot_isQueueFirst", isQueueFirst);
        }else{
            isQueueFirst = false;
            img_isQueueFirst.setBackgroundResource(R.drawable.sobot_demo_icon_close);
            SobotSPUtil.saveBooleanData(this, "sobot_isQueueFirst", isQueueFirst);
        }
    }
}