...
public class SobotInfomationFunctionActivity extends SobotDemoBaseActivity implements View.OnClickListener {
    ...
    protected int getContentViewResId() {
        return R.layout.sobot_demo_infomation_func_activity;
    }
